...
(0, _blueTape2.default)('fetchers/clubhouse', function (t) {
  t.test('getStory returns a Promise', function (tt) {
    tt.plan(1);
    ...
    (0, _nock2.default)('https://api.clubhouse.io').get('/api/v1/stories/123?token=not-a-real-token').reply(200, (0, _stringify2.default)(expected));

    return (0, _clubhouse.getStory)('not-a-real-token', 123).then(function (data) {
